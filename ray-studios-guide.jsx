      ...
      <div className="space-y-8">
        {current.sections.map((sec, i) => (
          <section key={i}>
            ...
            {/* Photo du matériel */}
            {sec.image && (
              <figure className="bg-white border border-stone-200 rounded-xl overflow-hidden">
                <img
                  src={sec.image.src}
                  alt={sec.image.alt}
            ...
            {/* Liste de composants / matériel */}
            {sec.parts && (
              <div className="space-y-2">
                {sec.parts.map((p, j) => (
                  <div key={j} className="bg-white border border-stone-200 rounded-xl p-5 flex gap-4">
                    <span
